...
const Header = () => {  
  ...
  return (
    <div className='h-20 flex justify-end static'>       
      <div className={isChecked ? 'backdrop-blur absolute bottom-0 left-0 size-full' : ''}></div>
      ...
      <div className={isChecked ? 'transition-all flex flex-col items-end absolute' : ''}>
        ...
        <nav className={`${ isChecked ? 'flex flex-col items-end' : 'hidden'} h-screen sm:flex sm:h-full bg-cool-blue `}> 
